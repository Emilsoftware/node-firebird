...
SQLVarDate.prototype.decode = function (data, lowerV13) {
    ...
    if (!lowerV13 || !data.readInt()) {
        ...
        d.setMilliseconds((ret - DateOffset) * TimeCoeff + 60 * MsPerMinute);
        return d;
    }
...
SQLVarTime.prototype.decode = function (data, lowerV13) {
    ...
    if (!lowerV13 || !data.readInt()) {
        ...
        d.setMilliseconds(Math.floor(ret / 10) + 60 * MsPerMinute);
        return d;
    }
    return null;
};
...
SQLVarTimeStamp.prototype.decode = function (data, lowerV13) {
    ...
    if (!lowerV13 || !data.readInt()) {
        ...
        d.setMilliseconds((date - DateOffset) * TimeCoeff + Math.floor(time / 10) + 60 * MsPerMinute);
        return d;
    }
